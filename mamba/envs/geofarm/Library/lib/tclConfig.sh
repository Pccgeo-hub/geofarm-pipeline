...
# installed.
TCL_PREFIX='D:/geofarm_epic1_starter/mamba/envs/geofarm\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/geofarm_epic1_starter/mamba/envs/geofarm\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/geofarm_epic1_starter/mamba/envs/geofarm\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/geofarm_epic1_starter/mamba/envs/geofarm\Library\include'
...
TCL_PACKAGE_PATH='D:/geofarm_epic1_starter/mamba/envs/geofarm\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/geofarm_epic1_starter/mamba/envs/geofarm\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/geofarm_epic1_starter/mamba/envs/geofarm\Library\lib\tclstub86.lib'
